...
def run_extraction():
    ...
    kb = {'product_title': {'class': 'product-title'}, 'price_value': {'class': 'price-color'}, 'patch_version': 31, 'unit_drift_active': True, 'last_session_repaired': 'SESS-5018'}
    try:
