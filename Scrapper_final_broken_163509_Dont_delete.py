...
# AegisFlow HEALED Scraper | Version: 8
...
def run_extraction():
    ...
    # FIX: kb is now injected as a Python dictionary string
    kb = {'product_title': {'class': 'product-title'}, 'price_value': {'class': 'price-color'}, 'patch_version': 8, 'unit_drift_active': True, 'last_session_repaired': 'SESS-2731'}
    ...
    try:
        ...
        # Self-Healing Logic for Unit Drift
